...
<div class="body_padded">
	<h1>Database Setup <span class="fui-gear"></span></h1>
	...
	<?= $this->data['DVWAOS'] ?><br />
	Backend database: <?= $this->data['DBMS'] ?><br />
	...
	<br />
	<i><span class="failure">Status in red</span>, indicate there will be an issue when trying to complete some modules.</i><br /><br />
