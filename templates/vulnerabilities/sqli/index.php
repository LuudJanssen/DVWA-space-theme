...
<div class="body_padded">
  ...
  <div class="vulnerable-code">
    <?php if ($this->data['vulnerabilityFile'] == 'high.php'): ?>
      Click <a href="#" onClick="javascript:popUp('session-input.php');return false;">here to change your ID</a>.
  ...
  <ul>
    ...
    <li><?= $this->externalLink('https://www.owasp.org/index.php/SQL_Injection') ?></li>
